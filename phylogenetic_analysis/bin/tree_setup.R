...
#read in OTU table 
table <- read.delim(paste(wd, "/diversity_analysis/data/arsC_thio_rformat_dist_0.1.txt", sep = ""), header = TRUE)
...
#save file
write.csv(table.normalized.t, paste(wd, "/phylogenetic_analysis/tree_data/arsC_thio_abund_label.csv", sep = ""),row.names = TRUE, quote = FALSE)
