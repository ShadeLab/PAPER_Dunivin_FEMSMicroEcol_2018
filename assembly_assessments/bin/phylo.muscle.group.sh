...
#cp ${BASEDIR}/${PROJECT}/OTUabundances/${GENE1}/complete.clust_rep_seqs_${CLUST}_unaligned.fasta ${GENE1}_complete.clust_full_rep_seqs_${CLUST}_unaligned.fasta
#cp ${BASEDIR}/${PROJECT}/OTUabundances/${GENE2}/complete.clust_rep_seqs_${CLUST}_unaligned.fasta ${GENE2}_complete.clust_full_rep_seqs_${CLUST}_unaligned.fasta
#cp ${BASEDIR}/${PROJECT}/OTUabundances/${GENE3}/complete.clust_rep_seqs_${CLUST}_unaligned.fasta ${GENE3}_complete.clust_full_rep_seqs_${CLUST}_unaligned.fasta
