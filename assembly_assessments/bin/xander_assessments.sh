...
#input for script includes gene, sample, and project names
#must manually add the full path next to RESULTDIR and BASEDIR
#where the results directory contains xander assembly resultls and the basedir 
# contains your post-assembly analysis directory
GENE=$1
SAMPLE=$2
PROJECT=$3
RESULTDIR=
